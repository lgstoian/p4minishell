...
/* This vendored BSP is driven by board_config.h (BOARD_BSP_ERROR_CHECK) rather
 * than a Kconfig, so it can coexist with the EV-board managed BSP. */
#ifndef BOARD_BSP_ERROR_CHECK
