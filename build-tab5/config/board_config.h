...
#define BOARD_CFG_LCD_DRAW_BUFFER_SIZE (BOARD_CFG_LCD_WIDTH * 100)
#define BOARD_CFG_LCD_DRAW_BUFFER_DOUBLE 1
...
// Measurement is read-only; charging itself is enabled once at boot via
// board_bsp_charge_enable() (see main.c), matching the M5Stack reference.
