...
- `bt` stays parser-visible but must remain disabled on the current ESP32-C6 hosted baseline until a proven BLE-safe host path is integrated; do not trade boot or Wi-Fi stability for Bluetooth experiments
