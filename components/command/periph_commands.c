...
static const shell_gpio_pin_desc_t s_gpio_pins[] = {
    ...
    {"hosted_sdio_d2", BOARD_CFG_HOSTED_SDIO_D2_GPIO, "ESP32-C6 hosted SDIO data lane D2", false, true},
    {"hosted_sdio_d3", BOARD_CFG_HOSTED_SDIO_D3_GPIO, "ESP32-C6 hosted SDIO data lane D3", false, true},
    {"hosted_sdio_clk", BOARD_CFG_HOSTED_SDIO_CLK_GPIO, "ESP32-C6 hosted SDIO clock", false, true},
    {"hosted_sdio_cmd", BOARD_CFG_HOSTED_SDIO_CMD_GPIO, "ESP32-C6 hosted SDIO command", false, true},
