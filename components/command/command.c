...
/* TUI primitives */
static bool shell_command_draw(int argc, char **argv);
static bool shell_command_anchor(int argc, char **argv);
...
static void shell_command_browse(int argc, char **argv)
{
