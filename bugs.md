# P4MiniShell — Bug Report & Test Campaign (v0.36.1, suite 262/0/2)

Date: 2026-08-24
Hardware: ESP32-P4 (rev 1.0) on COM11, ESP32-C6 co-processor, JD9165 display, SD card present
Firmware: **v0.36.1**. Current config baseline: transcript 65536 (`p4minishell_config.h:93`), async 512 (`:146`), internal trim 4096 (`:120`), SD DMA 4096 (`:621`), command worker stack 32768 (`:1467`), batch-file RAM cap 131072 (`:797`), TUI 80x25 (`:325/:328`). Suite: **262/0/2**.
...
| Open | 3 (O3 O(buffer) span rebuilds MOSTLY FIXED - deferral shipped; O4 host DTR-open reboots - host-mitigated; O5 silent-boot wedge - recovered, watch) | O3 residual is a rare single-output loss under TX pressure; O4/O5 noted, see OPEN section. O1/O2/O6/O7 fixed. |
