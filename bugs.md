# P4MiniShell — Bug Report & Test Campaign (v0.35.5 hardening, fail-closed truncations, OOM immediacy, 22 new tests)
...
## OPEN — remaining items — hardware pass (0.35.5 code done, verification deferred to the board session)
