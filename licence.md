# Licence Notice (v0.35.3 split, 80×25 `utf8[4]` TUI, `command.c` 6394→5808, `batch.c` 5195→4881)
...
## Version note (v0.35.3 split patch 0.35.2→0.35.3; prior v0.35.2 cleanup 0.35.1→0.35.2; hardware baseline v0.35.1)
