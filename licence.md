# Licence Notice (v0.38.2, suite 300/0/2)
...
## Version note (v0.38.2)
P4MiniShell v0.38.2 is hardware-verified on COM3 (ESP-IDF v5.5.5); the full suite is green (unit 300/0/2, companion deep 8/8, db 38/38, alarm 25/25, app smoke 21/21, package round-trip 15/15, plot 25/25). The TUI is an 80x25 cell buffer in the live transcript region. See `command.md` (commands), `API.md` (module APIs), `documentation.md` (architecture), and `SDK.md` (integration) for current details.