# Licence Notice (v0.35.4 split, `command.c` 5808→2467, periph/power/serial out)
...
## Version note (v0.35.4 split patch 0.35.3→0.35.4; prior v0.35.3 split 0.35.2→0.35.3; hardware baseline v0.35.1)
